...
// Just start picking smallest edges except those which make a cycle in the graph
...
public class KruskalAlgorithm {
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(graphEdges, (o1, o2) -> o1.weight.compareTo(o2.weight));
    ...
    private static void union(Set[] subsets, int x, int y) {
    ...
    private static int findRoot(Set[] subsets, int i) {
