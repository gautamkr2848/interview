...
class Elevator {
    ...
    public void addJob(Request request) {
        System.out.println("Got the request from floor " + request.getExternalRequest().getSourceFloor() + " to " + request.getInternalRequest().getDestinationFloor());
...
public class ElevatorTest {
    ...
    public static void main(String args[]) {
        ...
        elevator.startElevator();   // start elevator
